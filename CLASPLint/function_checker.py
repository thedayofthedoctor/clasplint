...
CLASPLint.function_checker — Validates function and class names against CLASP 3.0 snake_case and PascalCase conventions.
...
from .naming_utils import (
    ...
    validate_class_name,
    # Import the maximum name length constant.
    length_namemax,
...
class FunctionChecker(ast.NodeVisitor):
    """
    Walks the AST and validates function and class names against CLASP 3.0 naming conventions.

    Public methods:
        visit_ClassDef — Validates class names against PascalCase format and detects ast.NodeVisitor inheritance.
        visit_FunctionDef — Validates function and method names against snake_case format and length limits.
    ...
    Private methods:
        ...
        _init_add_violations_function_ — Records a list of naming violations with full source context.
        _init_detect_visitor_function_ — Determines whether a class inherits from ast.NodeVisitor for visit_* exemption.
    """
    ...
    def _init_add_violations_function_(self, string_name: str, string_category: str,
        ...
        :param string_name: The name of the function or class that triggered the violation.
    ...
    def visit_ClassDef(self, node: ast.ClassDef) -> None:
        ...
        Validates the class name against CLASP 3.0 rules, saves and restores the
    ...
    def _init_detect_visitor_function_(self, node: ast.ClassDef) -> bool:
        """
    ...
    def visit_AsyncFunctionDef(self, node: ast.AsyncFunctionDef) -> None:
        ...
        same CLASP 3.0 naming rules as synchronous functions and require no special
